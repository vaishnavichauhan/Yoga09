    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                ...
                isDisable = {text && text2 && text? false :true }  
                buttonStyle={text  && text2 ? styles.buttonStyle1: styles.buttonStyle2} 
                titleStyle={text   && text2? styles.titleStyle1: styles.titleStyle2}/>
